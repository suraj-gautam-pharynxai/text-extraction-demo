          ...
          <div className="flex flex-col items-center mt-12 space-y-4 md:flex-row md:justify-between md:space-y-0">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-500">
                © Phrynxai-PDF 2024 • Your PDF Editor
              </span>
            </div>
...
function AppleIcon(props) {
  return (
    <img className="h-7 w-7 bg-white rounded-full p-1" src="https://img.icons8.com/?size=100&id=OxHj0qshMjgV&format=png&color=000000" alt="" />
  );
}
...
function FilePenLineIcon(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
